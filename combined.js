...
columnNameCell
 ...
 highlightScope constant.numeric
 enum atlas atlasPaper brainMuseum ebrains reference wikipedia country description title appeared model type
blankCell
...
<div id="editForm">
 ...
 <div>
  ...
  async startCodeMirrorEditor() {
    this.fileParser = braindbParser // replaced at server time.
    this.codeMirrorInstance = new GrammarCodeMirrorMode("custom", () => braindbParser, undefined, CodeMirror).register().fromTextAreaWithAutocomplete(document.getElementById("fileContent"), {
      lineWrapping: false,
      lineNumbers: true
    })
